<?php 
    ...
    $entradas = paginacion_select_entradas($pag);
    $siguiente = pagina_siguiente($pag);
?>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../estilos/ultimos.css">
        ...
        <div class="principal">
            ...
            <div class="panel">
                <div class="panel_interior">
                    ...
                    <div class="botones_anterior_siguiente">
                        <?php
                            if ($pag > 0) {
                                echo "<a class='enlace_antes' href='ultimos.php?pag=" . $pag - 1 . "'>Pagina anterior</a>";
                            }
                            if ($siguiente) {
                                echo "<a class='enlace_antes' href='ultimos.php?pag=" . $pag + 1 . "'>Pagina siguiente</a>";
                            }
                        ?>
                    </div>
                </div>
